 ...
 *
 */
global $pgid,$uid,$goodname,$currency,$buyername,$buyertel,$buyeremail,$paymethod,
      $encrypted,$sessionkey,$cardcode,$parentemail,$recvname,$recvtel,$recvaddr,
      $recvpostnum,$recvmsg,$joincard,$joinexpire,$id_customer;
